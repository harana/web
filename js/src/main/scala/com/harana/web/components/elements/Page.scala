...
import com.harana.web.components.sidebar.Sidebar
import com.harana.web.components._
import com.harana.web.external.helmet.Helmet
import com.harana.web.external.shoelace.{Button, ButtonGroup, Dropdown, Menu}
import diode.Circuit
import slinky.core._
import slinky.core.annotations.react
import slinky.core.facade.{Fragment, ReactElement}
import slinky.web.html._
import com.harana.web.components.sidebar.{ContentSection, Sidebar, SidebarSection, Tab}
					...
					div(className := "page-header-content")(
						...
						when(props.toolbarItems.nonEmpty)(
							div(className := "heading-elements")(
								Toolbar(props.circuit, props.toolbarItems)
							)
						)
					)
				)
