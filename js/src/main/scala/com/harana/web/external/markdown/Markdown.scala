package com.harana.web.external.markdown

import com.harana.web.external.markdown.Types._
...
@react object Markdown extends ExternalComponent {
  ...
  case class Props(source: String,
                   allowElement: Option[(MarkdownAbstractSyntaxTree, Double, NodeType) => Boolean] = None,
