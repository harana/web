...
object GridStore {
  ...
  case class SaveNewItem(entityType: EntityType, userId: User.UserId, parameterValues: HMap[Parameter.Values]) extends DiodeAction
  case class SaveExistingItem(entityType: EntityType, userId: User.UserId, entityId: EntityId, parameterValues: HMap[Parameter.Values]) extends DiodeAction
